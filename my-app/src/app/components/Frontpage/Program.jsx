...
const Program = () => {
  return (
    <>
      <div className=" bg-[#E3E3E3] text-black  border-black flex items-center ">
        <div className="max-w-[1600px] mx-auto">
          <div className="flex justify-around flex-wrap gap-64 mt-40">
            ...
            <div className="font-extrabold text-6xl w-[400px] ml-auto">
