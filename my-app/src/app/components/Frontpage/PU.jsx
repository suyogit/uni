...
const PU = () => {
  return (
    <div
      className="flex items-center h-screen bg-black text-white relative z-20
         "
    >
      <div className="flex items-center max-w-[1600px] mx-auto gap-56">
        <div className="flex flex-col gap-12 items-center ">
          ...
          <div className="flex text-white gap-2 items-center">
            ...
            <p className="font-bold text-lg">Pokhara University</p>
          </div>
          <p>Purbanchal University</p>
          <p>University of Nepal</p>
        </div>
        <div className="flex flex-col gap-14 items-center">
          <h2 className="font-bold text-2xl">Pokhara University</h2>
